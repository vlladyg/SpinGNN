...
@compile_mode("script")
class Allegro_Module_c(GraphModuleMixin, torch.nn.Module):
    # saved params
    num_layers: int
    field: str
    out_field: str
    ...
    def forward(self, data: AtomicDataDict.Type) -> AtomicDataDict.Type:
        ...
        #print(data[AtomicDataDict.CHARGE_KEY])
        ...
        latent_inputs_to_cat = [
            ...
            data[AtomicDataDict.CHARGE_KEY][edge_center],
            data[AtomicDataDict.CHARGE_KEY][edge_neighbor],
            edge_invariants,
        ]
